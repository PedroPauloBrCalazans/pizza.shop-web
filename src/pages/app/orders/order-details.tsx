...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 18fa1f654f8sa94f</DialogTitle>
      ...
      <div className="space-y-6">
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell>Pizza de chocolate grande</TableCell>
            ...
            <TableRow>
              <TableCell>Pizza de frango grande</TableCell>
              <TableCell className="text-right">2</TableCell>
